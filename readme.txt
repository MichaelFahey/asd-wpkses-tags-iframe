=== ASD wpkses tags iframe ===
Contributors: michaelfahey
Tags: wp_kses, allowedtags, iframe
Requires PHP: 5.6
Requires at least: 3.6
Tested up to: 4.9.8
Stable tag: 1.201904141
License: GPLv3
License URI: https://www.gnu.org/licenses/gpl-3.0.html
Plugin URI:  https://artisansitedesigns.com/plugins/asd-wpkses-tags-iframe/
Author URI:  https://artisansitedesigns.com/staff/michael-h-fahey/
Donate link: https://paypal.me/artisanmichaelfahey

=== Description ===
This plugin configures WordPress sanitizing functions such as wp_kses to allow the iframe tag, and the type attribute for the iframe tag. It does not affect any other allowed/disallowed tags or attributes.
...
git clone https://github.com/MichaelFahey/asd-wpkses-tags-iframe.git
